    ...
    <>
      < div className="p-6" >
        <div className='border-t-2 border-gray-20 pt-4 mt-8'>
          <h2 className="text-2xl font-bold mb-4 px-2 py-1 rounded-full text-yellow-600 bg-yellow-100 text-center">Shortlisted Applications</h2>
        </div>
          ...
          {applications.map(application => (
            <Card key={application._id} className="shadow-md rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="bg-yellow-100 text-yellow-700 text-xs px-3 py-1 rounded-full">Shortlisted</span>
              </div>
