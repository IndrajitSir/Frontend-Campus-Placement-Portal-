...
function PlacementStaff() {
    ...
    async function getDataV2() {
        try {
            ...
            console.error("Failed to fetch placement staff", err);
            toast.error("Failed to fetch placement staff");
        } finally {
            setLoading(false);
        }
    }
    ...
    return (
        <div className="w-full space-y-5 pt-6">
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                {(Array.isArray(placementStaff) ? placementStaff : []).map((user, i) => (
                    <motion.div
                        key={user?._id}
                            ...
                            <div className="mt-4 flex justify-end border-t border-slate-100 pt-3">
                                <TooltipProvider delayDuration={200}>
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="top"><p>Delete staff</p></TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                            </div>
                        </Card>
