...
function PlacementStaff() {
    ...
    async function getData() {
        const res = await fetch(`${API_URL}/api/v1/users/placement-staff-all`, {
            method: "GET",
            headers: {
        ...
        setPlacementStaff(response?.data);
    }
    useEffect(() => {
        getData();
    }, [])
    return (
        <>
            < div className="p-6" >
                <h2 className="text-2xl font-bold mb-4">All Placement Staffs</h2>
