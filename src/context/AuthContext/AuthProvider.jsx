...
export const AuthCrediantialsProvider = ({ children }) => {
    ...
    return (
      <>
        <AuthContext.Provider value={{ role, setRole, accessToken, setAccessToken, refreshToken, setRefreshToken, userInfo, setUserInfo, fetchUserData, handleAvatarUpload, handleDeleteResume, handleResumeUpload }}>
          {children}
