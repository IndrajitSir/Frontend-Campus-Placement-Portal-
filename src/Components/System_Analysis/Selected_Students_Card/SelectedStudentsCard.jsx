            ...
            <Card className="w-full shadow-md">
                <CardContent>
                    ...
                    <BarChart width={1300} height={250} data={data}>
                        ...
                        <Tooltip />
                        <Bar dataKey="selected" fill="#ff7300" radius={[4, 4, 0, 0]}/>
                        <Bar dataKey="applied" fill="#ff7300" radius={[4, 4, 0, 0]}/>
                        <Bar dataKey="shortlisted" fill="#ff7300" radius={[4, 4, 0, 0]}/>
                        <Bar dataKey="rejected" fill="#ff7300" radius={[4, 4, 0, 0]}/>
                    </BarChart>
                </CardContent>
            </Card>
        </>
